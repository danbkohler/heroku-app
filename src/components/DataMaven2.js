...
//let addresses;
//Backup of DataMaven, with messy code
...
class DataMaven extends Component {
    ...
    componentDidMount() {
        ...
        dataLoader.loadAddresses(function(addressCount) {
            ...
            const address = getByIndex(that.state.addressIndex);
            that.setState({
    ...
    onAddressChange(event) {
        detailLogger.log('onAddressChange called with', event.target.id);
        let delta = this.state.addressIndex;
        if (this.state.addressIndex < this.state.addressCount) {
            delta++;
        }
        detailLogger.log('addressIndex', this.state.addressIndex);
        const address = getByIndex(delta);
    ...
    //Commenting out references to address
    /*
